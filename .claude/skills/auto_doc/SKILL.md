---
name: auto_doc
description: Save explanations about concepts, termilogies, and principles from our conversations into a knowledge base
---

## When to use this skill

When user asks questions (usually starting with **why, what, and how**):
...
**And** user wants to save the summary of the conversation (keywords such as "summarize", "save", "documentation" may appear in the conversation).

## What this skill does

1. When detecting user is asking a question, give a short hint about this skil (e.g. "You may use skill auto_doc to summarize following conversation").
2. **Looks for existing notes** in `docs/` to see if we've talked about this before
3. **Merges with existing notes** if the topic already exists, or creates a new file if it's new
4. **Organizes user's questions and claude code's answers** into clean markdown files
...
- Try using codeblocks to show the code and visualization.
...
type: background_knowledge (not related to programing or coding directly) or trouble_shooting (related to programing or coding)
---
